                ...
                @foreach($contacts as $contact)
                    <div id="contact_id_{{ $contact->id }}" class="row">
                        ...
                        <div class="col-lg-5 border border-1">
                            ...
                            <div class="row">
                                <div class="col-lg">
                                    <input type="text" name="contact[{{ $contact->id }}][first_name]"
                                           value="{{ $contact->first_name }}">
                                </div>

                                <div class="col-lg">
                                    <input type="text" name="contact[{{ $contact->id }}][last_name]"
                        ...
                        <div class="col-lg-7 border border-1">
                            ...
                            <div id="contact_id_{{ $contact->id }}_phones"
                                 class="js-wrapper"
...
{{--                                        <input type="hidden" value="$(this).parent.attr('contactid')">--}}
                                        ...
                                        <input type="hidden" name="phone_number[{{ $contactPhone->id }}][contact_id]"
                                        value="{{ $contact->id }}">

                                        <div class="col-lg-4 border border-1">
                                            <input type="text"name="phone_number[{{ $contactPhone->id }}][description]"
                            ...
                            <div class="row">
                                <div class="col-lg border border-1">
                                    <button onclick="addNewNumberField('#contact_id_{{ $contact->id }}_phones', {{ $contact->id }})"
                                            type="button"
                                            class="c-button-link"
                                    >
                                        Add number
